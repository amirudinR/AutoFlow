...
const replacements = [
  ...
  // specific fixes for buttons that became text-slate-800 but should be text-white since they are blue
  { from: /bg-blue-600 text-black/g, to: 'bg-blue-600 text-white' },
  { from: /bg-[#24d38b] hover:bg-[#1fb879] text-black/g, to: 'bg-blue-600 hover:bg-blue-700 text-white' },
];
